...
There are usually some outstanding feature requests in the [existing issues list](https://github.com/khoih-prog/WiFi101_Generic/issues?q=is%3Aopen+is%3Aissue+label%3Aenhancement), feel free to add comments to them.
...
```
xy@xy-Inspiron-3593:~$ cd Arduino/xy/WiFi101_Generic_GitHub/
xy@xy-Inspiron-3593:~/Arduino/xy/WiFi101_Generic_GitHub$
```

2. Issue astyle command

```
xy@xy-Inspiron-3593:~/Arduino/xy/WiFi101_Generic_GitHub$ bash utils/restyle.sh
```
