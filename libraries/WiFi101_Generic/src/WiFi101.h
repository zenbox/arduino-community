...
#include "utility/WiFi101_debug.h"

// KH rewrite to enable chunk-sending for large file

#if !defined(WIFI_CLIENT_MAX_WRITE_RETRY)
  #define WIFI_CLIENT_MAX_WRITE_RETRY       100
#endif

#if !defined(WIFI_CLIENT_SEND_MAX_SIZE)
  #define WIFI_CLIENT_SEND_MAX_SIZE       4032
#endif

////////////////////////////////////////

#if !defined(WIFI_SERVER_MAX_WRITE_RETRY)
  #define WIFI_SERVER_MAX_WRITE_RETRY       100
#endif

#if !defined(WIFI_SERVER_SEND_MAX_SIZE)
...
class WiFiClass
{
  public:
    ...
    */
    ...
    uint8_t begin(const String &ssid)
    {
    ...
    uint8_t begin(const String &ssid, uint8_t key_idx, const String &key)
    {
      return begin(ssid.c_str(), key_idx, key.c_str());
    }

    ////////////////////////////////////////

    uint8_t begin(const String &ssid, const String &key)
    {
      return begin(ssid.c_str(), key.c_str());
    }
